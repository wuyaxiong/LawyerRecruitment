 ...
 */
public class NeibuzhuanjiaFragment extends BaseFragment implements View.OnClickListener, YRecycleview.OnRefreshAndLoadMoreListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_neibuzhuanjia, container, false);
        initData();
        initView(v);
        return v;
    }
    private void initView(View v) {
        yRecycleview= (YRecycleview) v.findViewById(R.id.sendzj_neibuzhuanjia);
