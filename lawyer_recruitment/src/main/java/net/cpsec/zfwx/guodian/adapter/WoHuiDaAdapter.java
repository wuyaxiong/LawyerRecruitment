...
public class WoHuiDaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private Context context;
    private WoHuiDaBean inforBeen;
    ...
    public WoHuiDaAdapter(Context context,WoHuiDaBean inforBeen) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        list = new ArrayList<>();
        list.clear();
        String tupian = inforBeen.getInfor().get(position).get(0).getImage();
        ...
        ImageLoader.getInstance().displayImage("http://" + inforBeen.getInfor().get(position).get(0).getUserpic(), ((ViewHolder) holder).riv_avadar);
        ((ViewHolder) holder).tv_name.setText(inforBeen.getInfor().get(position).get(0).getUsername());
        ((ViewHolder) holder).tv_title.setText(inforBeen.getInfor().get(position).get(0).getContent());
        ((ViewHolder) holder).tv_shijian.setText(DateUtil.converTime(inforBeen.getInfor().get(position).get(0).getTime()));
        ((ViewHolder) holder).tv_label.setText(inforBeen.getInfor().get(position).get(0).getName());
        ((ViewHolder) holder).tv_dianzan.setText(inforBeen.getInfor().get(position).get(0).getPraise()+"");
        ((ViewHolder) holder).tv_huifu.setText(inforBeen.getInfor().get(position).get(0).getComment()+"");
    ...
    public int getItemCount() {
        return inforBeen.getInfor().size();
    }
