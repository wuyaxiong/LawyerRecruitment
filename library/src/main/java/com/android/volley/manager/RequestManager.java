...
public class RequestManager {
     ...
     * @param data            String, Map<String, String> or RequestMap(with file)
     * @param requestListener
     * @param headers         消息头session
     * @param actionId
     * @return LoadControler object
     */
    public LoadController post(final String url, Object data,
                               final RequestListener requestListener, final Map<String, String> headers, int actionId) {
        return this.post(url, data, requestListener, headers, false, TIMEOUT_COUNT,
                RETRY_TIMES, actionId);
    }
     ...
     */
    public LoadController post(final String url, Object data,
                               final RequestListener requestListener, final Map<String, String> headers, boolean shouldCache,
                               int timeoutCount, int retryTimes, int actionId) {
        return request(Method.POST, url, data, headers, requestListener,
                shouldCache, timeoutCount, retryTimes, actionId);
    }
